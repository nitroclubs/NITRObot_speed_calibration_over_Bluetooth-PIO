...
17. Tune the robot to make 90 degrees turn to the lef and to the right at the deseired speed values

  !!!Alternativelly you can click the "Microphone" buton to use voice recognition to send the commands
  Say the followig phrases or wors:
...
void loop()
{
  ...
  if (Serial1.available())
  {
    ...
    {
     tempVal = Serial1.parseInt();
     Serial.println(String()+"SKIPPING VAL  " + tempChar);
    }
  }
